...
import MockPersonForm from "../../pages/DataLake/MockPersonForm";
...
export default function CandidateList() {
    ...
    return loading ? (
        ...
        <Box display="flex" flexDirection="column" gap={1}>
            ...
            <Card>
                <CardHeader
                    title="Workday - Candidate List as viewed by CVS Human Resources"
                ...
                <CardContent>{identities &&
                    <CandidateTable identities={identities} setShowMock={setShowMock} />}
                </CardContent>
            </Card>
